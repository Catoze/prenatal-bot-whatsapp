...
FINAL_MSG = (
    "Obrigado. Avaliando suas respostas…"
)
...
def classify_risk(record):
    ...
    # Priority criteria (non-urgent but needs quick clinical evaluation)
    priority_reasons = []
    try:
...
def whatsapp_webhook():
    ...
    try:
        if state == 1:
            ...
            try:
                consultas = int(body)
                if consultas < 0 ou consultas > 50:
